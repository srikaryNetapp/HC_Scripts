        ...
        with MySqlCon(ocum,config) as con:
            if not con is None:
                ...
                for i in range(0,len(cluster_ids)):
                    ...
                    END AS 'Days To Full'
                    FROM ocum.aggregatecapacityutilizationview where clusterId = {cluster_ids[i]};
                    """
                   ...
                   str)
                    ...
                    <table>
                    <tr>
                    <th style="text-align: left;width:fit-content;text-transform: uppercase;color: black;background-color: #605ef5;border;1px solid #eee;padding: 12px 36px;font-size;10px;">{Cluster_names[i]}</th>
                    </tr>
                    <tr>
                    <td>{html_out}</td>
                    </tr>
